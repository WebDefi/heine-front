...
const AcessoriesCats = lazy(() =>
  import("./pages/AccessoriesCats/AccessoriesCats")
);
const News = lazy(() => import("./pages/News/News"));
const Contacts = lazy(() => import("./pages/Contacts/Contacts"));
const NewsDetails = lazy(() =>
  import("./pages/News/components/NewsDetails/NewsDetails")
);
const Service = lazy(() => import("./pages/Service/Service"));
const ListProducts = lazy(() => import("./pages/ListProducts/ListProducts"));
const AccessoriesList = lazy(() =>
  import("./pages/AccessoriesList/AccessoriesList")
);
